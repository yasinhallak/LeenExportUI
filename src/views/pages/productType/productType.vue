<template>
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="productTypes">
      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
        ...
        <vs-dropdown vs-trigger-click class="cursor-pointer mb-4 mr-4 items-per-page-handler">
          <div class="p-4 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
            <span class="mr-2">{{ currentPage * itemsPerPage - (itemsPerPage - 1) }} - {{ productTypes.length - currentPage * itemsPerPage > 0 ? currentPage * itemsPerPage : productTypes.length }} of {{ queriedItems }}</span>
...
import moduleProductType from '@/store/productType/moduleProductType.js'
...
export default {
  ...
  computed: {
    ...
    queriedItems () {
      return this.$refs.table ? this.$refs.table.queriedResults.length : this.productTypes.length
    }
  },
  methods: {
    addNewData () {
    ...
    deleteRecord(){
      ...
      this.$store.dispatch('productType/removeItem', this.removeItem)
  ...
  created () {
    if (!moduleProductType.isRegistered) {
